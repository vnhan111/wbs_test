    ...
    const projects = [
        {
            ...
            projectLead: 'Nguyen Van A',
            checklistStatus: 'In Progress',
            checkDate: '15/01/2026'
        },
        {
            id: 2,
            name: '#IHP_MobileApp',
            ...
            projectLead: 'Tran Thi B',
            checklistStatus: 'Not Started',
            checkDate: '01/03/2026'
        },
        {
            id: 3,
            name: '#IHP_WebsiteRedesign',
            status: 'Completed',
            priority: 'Low',
            startDate: '01/03/2026',
            endDate: '30/06/2026',
            skills: 'HTML, CSS, JavaScript',
            projectLead: 'Le Van C',
            checklistStatus: 'Completed',
            checkDate: '30/06/2026'
        },
        {
            id: 4,
            name: '#IHP_MarketingCampaign',
            status: 'On Hold',
            priority: 'High',
            startDate: '01/04/2026',
            endDate: '31/12/2026',
            skills: 'SEO, Content Creation',
            projectLead: 'Pham Thi D',
            checklistStatus: 'In Progress',
            checkDate: '15/05/2026'
        },
        {
            id: 5,
            name: '#IHP_DataMigration',
            status: 'In Progress',
            priority: 'Medium',
            startDate: '15/05/2026',
            endDate: '15/11/2026',
            skills: 'SQL, ETL',
            projectLead: 'Hoang Van E',
            checklistStatus: 'Not Started',
