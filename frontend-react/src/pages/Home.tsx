...
const Home: React.FC = () => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (result.success) {
                console.log("New project data", result.data);
    ...
    const openEditModal = async (projectId: number) => {
        ...
        if (result.success && result.data) {
            setFormEditData({
                ...
                projectStatusId: result.data.projectStatusId || 1,
                expectedStartDate: result.data.expectedStartDate
                    ? result.data.expectedStartDate.split('T')[0]
                    : "",
    ...
    const handleEditProject = async () => {
        ...
        try {
            const updateData = {
                projectCode: formEditData.projectCode,
                projectName: formEditData.projectName,
            ...
            if (result.success) {
                console.log("Update project successfull:", result.data);
    ...
    const handleDeleteProject = async (projectId: number) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                message.warning(result.error || "Project not found or already deleted.");
            }
        } catch (error) {
            message.error("An error occurred while deleting the project. Please try again.");
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                ...
                                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                    {projects.filter(project => !project.projectDeleteStatus).map(project => (
                                        <tr
                                        ...
                                        >
                                            <td className="px-6 py-4 flex gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className="p-1 rounded-md bg-red-500 hover:bg-red-600 text-white transition-colors" title="Delete">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className='h-3 w-3'>
